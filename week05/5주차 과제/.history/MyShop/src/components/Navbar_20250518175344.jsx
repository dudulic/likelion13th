...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile SideBar */}
      <div className={`dt:hidden ph:fixed top-0 right-0 h-full w-64 bg-black transform transition-transform duration-100 ease-in-out ${isOpen?'translate-x-0':'translate-x-full'}z-40`}></div></div>
    </>
  );
};
