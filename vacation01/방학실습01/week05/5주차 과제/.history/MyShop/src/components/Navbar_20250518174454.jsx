...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation */}
      <nav className="dt:hidden ph:flex fixed top-0 border-b-1 border-gray-600 left -0 right-0 h-20 bg-black text-white items-center justify-between px-6 z-50"><Link to="/">MyShop</Link>
        <Link to="/Profile">
          <img src={FrameProfile} alt="profile" className="w-6 h-6" />
        </Link>
      </nav>
